...
#define FLASH_BASE 0x40022000          // Base address of the flash handleController
...
GMAC_REGS->GMAC_RBQB = (uint32_t) s_rxdesc;  // Let the handleController know
...
// enable handleController, set RGMII mode
